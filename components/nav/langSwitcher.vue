<template>
    ...
    <button 
    @click="open = !open" 
    class="flex justify-between rounded-full w-fit p-1 bg-primary transition-colors duration-200 ease-in-out hover:bg-tertiary hover:text-cyan-300 text-lg text-white mx-2 my-2 px-2"
